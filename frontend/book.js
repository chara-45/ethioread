...
const book = extremeshelf.find(b => b.id === id);

if(!favabook.some(b => b.id === id)){
    favabook.push(book);
    btn.style.backgroundColor = "yellow";
}else{
    favabook = favabook.filter(b => b.id !== id);
    btn.style.backgroundColor = "white";
}

localStorage.setItem("favorites", JSON.stringify(favabook));
console.log(favabook)
}
