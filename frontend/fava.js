...
const bookContainer = document.querySelector('.favabook');

favabook.forEach(function(value) {
        const html = `
        <div class="bookshelf">
            <a href='${value.id}.pdf' target='_blank'>
                <img src='bookshelf/${value.id}.jpg'/>
            </a>
            <p>${value.name}</p>
        <button class="favabu" onclick="addFavorite('${value.id}', this)">
